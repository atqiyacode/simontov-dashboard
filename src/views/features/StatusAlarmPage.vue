...
import { useStatusAlarmStore } from '@/services/features/StatusAlarm.store';
import { storeToRefs } from 'pinia';
const mainStore = useMainStore();
const StatusAlarmStore = useStatusAlarmStore();
