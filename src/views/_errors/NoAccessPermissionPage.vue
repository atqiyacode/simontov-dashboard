...
<template>
    ...
    >
        <div class="flex flex-column align-items-center justify-content-center shadow-5">
            <img
            ...
            >
                <div
                    class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center shadow-5"
