...
// mounted
onMounted(() => {
    title.value = 'Auth Verification Method Page';
    api.value = '/master/authVerificationMethod';
    tableBody.value = [
...
proxy.$pusher.channel('auth-verification-method-channel').listen('.auth-verification-method-event', () => {
    getData();
});
</script>
