...
const setInputStyle = () => {
    localStorage.setItem('inputStyle', layoutConfig.inputStyle.value);
};
const setMenuMode = () => {
...
const theme = ref(layoutConfig.darkTheme);
...
<template>
    ...
    >
        ...
        <template v-if="!simple">
            ...
            <h5>Ripple Effect</h5>
            <InputSwitch @change="setRipple" v-model="layoutConfig.ripple.value"></InputSwitch>

            <h5>Dark Mode</h5>
            <InputSwitch @change="setTheme" v-model="theme"></InputSwitch>
        </template>
    </Sidebar>
</template>
