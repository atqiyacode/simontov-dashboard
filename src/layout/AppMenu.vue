...
<template>
    <ul class="layout-menu" style="padding: 0.5rem 1.5rem" v-if="user?.roles[0] === 'superman'">
        <template v-for="(item, i) in supermanMenu" :key="item">
            <app-menu-item v-if="!item.separator" :item="item" :index="i"></app-menu-item>
            <li v-if="item.separator" class="menu-separator"></li>
        </template>
    </ul>
    <ul class="layout-menu" style="padding: 0.5rem 1.5rem" v-if="user?.roles[0] === 'superadmin'">
        <template v-for="(item, i) in superadminMenu" :key="item">
            <app-menu-item v-if="!item.separator" :item="item" :index="i"></app-menu-item>
            <li v-if="item.separator" class="menu-separator"></li>
        </template>
    </ul>
    <ul class="layout-menu" style="padding: 0.5rem 1.5rem" v-if="user?.roles[0] === 'admin'">
